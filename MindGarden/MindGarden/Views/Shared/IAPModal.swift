...
//        }!
//        Purchases.shared.purchasePackage(package) { [self] _, purchaserInfo, _, _ in
...
//                package.product.productIdentifier == "io.bytehouse.mindgarden.freeze"
//            }!
//            price = freezePrice
...
//        case "potion":
//            package = packagesAvailableForPurchase.last { package -> Bool in
//                package.product.productIdentifier == "io.bytehouse.mindgarden.potion"
//            }!
//            price = potionPrice
...
//        case "chest":
//            package = packagesAvailableForPurchase.last { package -> Bool in
//                package.product.productIdentifier == "io.bytehouse.mindgarden.monthly"
//            }!
//            price = chestPrice
//            event2 = "chest" + event2
//            event3 += "chest"
