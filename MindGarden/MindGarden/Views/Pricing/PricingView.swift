...
//            case "lockedMeditation": viewRouter.currentPage = .categories(incomingCase: .home)
...
//
//            case "journey": viewRouter.currentPage = .journey
//            case "quickStart": viewRouter.currentPage = .quickStart
//            case "learn": viewRouter.currentPage = .learn
//
...
class PricingViewHelperViewController: UIViewController {
    ...
    var viewRouter: ViewRouter = .init()
    lazy var authModel = AuthenticationViewModel(userModel: SceneDelegate.userModel, viewRouter: viewRouter)
...
//        hostingController.didMove(toParent: self)
    ...
    func crossButtonBack() {
        ...
        withAnimation {
            ...
            case "home": viewRouter.currentPage = .meditate
            case "profile": viewRouter.currentPage = .meditate
            case "onboarding": viewRouter.currentPage = .middle(incomingCase: .journeyMiddle)
            case "store": viewRouter.currentPage = .shop
            case "onboarding2": viewRouter.currentPage = .meditate
            case "lockedMeditation": viewRouter.currentPage = .categories(incomingCase: .home)
            case "lockedHome": viewRouter.currentPage = .meditate
            case "middle": viewRouter.currentPage = .middle(incomingCase: .journeyMiddle)
            case "widget": viewRouter.currentPage = .meditate
            case "discover": viewRouter.currentPage = .learn
            case "journal": viewRouter.currentPage = .learn
            case "garden": viewRouter.currentPage = .garden
