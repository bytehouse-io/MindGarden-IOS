...
struct LeaveFeedback: View {
    ...
    var subscriptionTuples = [
        ("I have a question about my subscription (Please don’t change subject line)", "Question about Subscription"),
        ("Pro features did not unlock, even though I purchased a subscription (Please don’t change subject line)", "Pro features didn't unlock"),
        ("I’d like to cancel my subscription or trial (Please don’t change subject line)", "I want to cancel my subscription"),
        ("I’d like a refund on my subscription. (Don’t Change Subject Line)", "I want a refund")
    ]
