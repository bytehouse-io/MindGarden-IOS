...
extension View {
    func takeStreakSceneScreenshot(origin: CGPoint, size: CGSize) -> UIImage {
        ...
        let hosting = UIHostingController(rootView: environmentObject(SceneDelegate.userModel)
...
struct BubbleEffectView: View {
    @StateObject var viewModel: BubbleEffectViewModel = .init()
...
class BubbleEffectViewModel: ObservableObject {
    @Published var viewBottom: CGFloat = .zero
