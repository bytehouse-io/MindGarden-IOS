...
struct Plant: Hashable {
    ...
    static var plants: [Plant] = [
        ...
        Plant(title: "Cactus", price: 130, selected: false, description: "Cactuses are type of desert plant that has thick, leafless stems covered in prickly spines or sharp spikes, some cacti are able to store hundreds of gallons of water. Cactus originates from the Greek name Kaktos.", packetImage: Img.cactusPacket, one: Img.cactus1, two: Img.cactus2, coverImage: Img.cactus3, head: Img.redTulipHead, badge: Img.redTulipsBadge),
        Plant(title: "Blueberry", price: 150, selected: false, description: "Blueberries are a crown forming, woody, perennial shrub in the flower family Ericaceae. They ranked number one in antioxidant health benefits in a comparison with more than 40 fresh fruits and vegetables.", packetImage: Img.redTulipsPacket, one: Img.blueberry1, two: Img.blueberry2, coverImage: Img.blueberry3, head: Img.blueberryHead, badge: Img.blueberryBadge),
        //missing head, packet
        Plant(title: "Monstera", price: 160, selected: false, description: "The Monstera  also known as the swiss cheese plant is native to Central America. It is a climbing, evergreen perennial vine that is perhaps most noted for its large perforated leaves on thick plant stems and its long cord-like aerial roots", packetImage: Img.lilyValleyPacket, one: Img.monstera1, two: Img.monstera2, coverImage: Img.monstera3, head: Img.lilyValleyHead, badge: Img.monsteraBadge),
        //missing packet
        Plant(title: "Daffodil", price: 100, selected: false, description: "Daffodils are reliable spring-flowering bulbs. They symbolize new beginnings & friendships and were also named after a greek myth.", packetImage: Img.redTulipsPacket, one: Img.daffodil1, two: Img.daffodil2, coverImage: Img.daffodil3, head: Img.daffodilHead, badge: Img.daffodilBadge),
        //head & packet
        Plant(title: "Rose", price: 140, selected: false, description: "Roses are woody perennial flowering plant of the genus Rosa, in the family Rosaceae. They're one of the oldest flowers & are commonly used in perfumes. They symbolize romance, love, beauty, and courage.", packetImage: Img.redTulipsPacket, one: Img.rose1, two: Img.rose2, coverImage: Img.rose3, head: Img.blueberryHead, badge: Img.roseBadge),
        //head
        Plant(title: "Lavender", price: 100, selected: false, description: "Lavenders are small, branching and spreading shrubs with grey-green leaves and long flowering shoots. They have a wonderful and aromatic smell and symbolize purity, silence, devotion, serenity, grace, and calmness", packetImage: Img.lavenderPacket, one: Img.lavender1, two: Img.lavender2, coverImage: Img.lavender3, head: Img.blueberryHead, badge: Img.lavenderBadge),
        //head
        Plant(title: "Sunflower", price: 110, selected: false, description: "Sunflowers are annual plants, harvested after one growing season and can reach 1–3.5 m (3.3–11.5 ft) in height. They symbolize include happiness, optimism, honesty, longevity, peace, admiration, and devotion", packetImage: Img.sunflowerPacket, one: Img.sunflower1, two: Img.sunflower2, coverImage: Img.sunflower3, head: Img.blueberryHead, badge: Img.sunflowerBadge),
