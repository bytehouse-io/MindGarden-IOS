...
struct Plant: Hashable {
    ...
    static var plants: [Plant] = [
        Plant(title: "Real Tree", price: 7000, selected: false, description: "🌳 Trees for the Future (TREES) trains communities on sustainable land use so that they can grow vibrant economies, thriving food systems, and a healthier planet.", packetImage: Img.treePacket, one: Img.sapling, two: Img.youngTree, coverImage: Img.realTree, head: Img.leaf, badge: Img.realTree),
