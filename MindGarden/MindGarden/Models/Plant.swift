...
struct Plant: Hashable {
    ...
    static var plants: [Plant] = [
        ...
        Plant(title: "Avocados", price: 250, selected: false, description: "🥑 Native to the highland regions of south-central Mexico to Guatemala. An avocado contains more patassium then a banana!", packetImage: Img.lemonPacket, one: Img.lemon1, two: Img.lemon2, coverImage: Img.lemonTree, head: Img.lemonHead, badge: Img.lemonBadge),
