...
struct Plant: Hashable {
    ...
    static var plants: [Plant] = [
        ...
        Plant(title: "Lemons", price: 200, selected: false, description: "🍋 Lemons are native to Asia, are a hybrid between a sour orange and a citron, rich in vitamin C and their trees can produce up to 600lbs of lemons every year.", packetImage: Img.lemonPacket, one: Img.lemon1, two: Img.lemon2, coverImage: Img.lemonTree, head: Img.lemonHead, badge: Img.lemonBadge),
        Plant(title: "Avocados", price: 250, selected: false, description: "🥑 Native to the highland regions of south-central Mexico to Guatemala. An avocado contains more patassium then a banana!", packetImage: Img.avoacdoPacket, one: Img.avocado1, two: Img.avocado2, coverImage: Img.avocado3, head: Img.avocadoHead, badge: Img.avocadoBadge),
