...
struct Breathwork: Hashable {
    ...
    static var breathworks: [Breathwork] = [
        ...
        Breathwork(title: "Pain Relief", sequence: [(4, "i"), (4, "h"), (6, "e")], duration: 14,  color: .vitality, description: " This exercise was designed to help alleviate pain throughout your body by increasing oxygenation and circulation. Great for headaches, muscle pain, and more.", category: .anxiety, img: Img.sun, id: -7, instructor: "none", isNew: false, recommendedUse: ["Tense Muscles", "Headache", "Hangover", "Body Ache"], tip: "Breathe with your belly and try to keep your chest and shoulders as still as possible."),
        Breathwork(title: "Vitality", sequence: [(4, "i"), (4, "h"), (4, "e")], duration: 12,  color: .vitality, description: "This exercise used by navy SEALS has many benefits including reduced stress, lower blood pressure and cortisol levels, increased focus and elevated mood.", category: .anxiety, img: Img.sun, id: -8, instructor: "none", isNew: false, recommendedUse: ["Anytime", "Low Energy", "Low Focus", "Stressed/Overwhelmed"], tip: "Try to keep your chest and shoulders as still as possible."),
    ]
}
