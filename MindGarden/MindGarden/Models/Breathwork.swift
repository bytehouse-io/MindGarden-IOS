...
struct Breathwork: Hashable {
    ...
    static let lockedBreaths = [-4, -5, -8]
    static func == (lhs: Breathwork, rhs: Breathwork) -> Bool {
        return lhs.id == rhs.id
    }
    static var lockedMeditations: [Int] = [-7, -8, ]
    static var breathworks: [Breathwork] = [
        ...
        Breathwork(title: "Pain Relief", sequence: [(4, "i"), (4, "h"), (6, "e")], duration: 14,  color: .vitality, description: " This exercise was designed to help alleviate pain throughout your body by increasing oxygenation and circulation. Great for headaches, muscle pain, and more.", category: .anxiety, img: Img.painrelief, id: -7, instructor: "none", isNew: false, recommendedUse: ["Tense Muscles", "Headache", "Hangover", "Body Ache"], tip: "Breathe with your belly and try to keep your chest and shoulders as still as possible."),
        Breathwork(title: "Vitality", sequence: [(4, "i"), (4, "h"), (4, "e")], duration: 12,  color: .vitality, description: "This exercise used by navy SEALS has many benefits including reduced stress, lower blood pressure and cortisol levels, increased focus and elevated mood.", category: .anxiety, img: Img.vitality, id: -8, instructor: "none", isNew: false, recommendedUse: ["Anytime", "Low Energy", "Low Focus", "Stressed/Overwhelmed"], tip: "Try to keep your chest and shoulders as still as possible."),
    ]
}
