...
//        Meditation(title: "Open-Ended Meditation", description: "Unguided meditation with no time limit, with the option to add a gong sounds every couple of minutes.", belongsTo: "none", category: .unguided, img: Img.starfish, type: .course, id: 1, duration: 0, reward: 0),
        ...
        Meditation(title: "Thankful Meditaiton for Gratitude", description: "Gratitude is the easiest thing you can do to become happier, learn to truly be thankful when having a clear focused mind.", belongsTo: "7 Days to Happiness", category: .growth, img: Img.hands, type: .single_and_lesson, id: 20, duration: 608, reward: 10, url: "https://mcdn.podbean.com/mf/web/ez7xsw/1456C_Thankful_Meditation_for_Gratitude_10_min_VOCALSbfhth.mp3"),
        ...
        Meditation(title: "Studying Meditation", description: "Want an edge over your classmates? Use this meditation before very study session to enter a laser focused state.", belongsTo: "none", category: .focus, img: Img.kidStudying, type: .single, id: 55, duration: 670, reward: 12, url: "https://mcdn.podbean.com/mf/web/293n4c/meditation-for-studying.mp3"),
        Meditation(title: "Exam Anxiety Meditation", description: "Feeling test jitters? Can't focus? Overthinking? Use this meditation to enter a calm zen state.", belongsTo: "none", category: .anxiety, img: Img.cando, type: .single, id: 56, duration: 485, reward: 10, url: "https://mcdn.podbean.com/mf/web/4ywe6m/exam-anxiety-meditation.mp3"),
