...
//        Meditation(title: "Open-Ended Meditation", description: "Unguided meditation with no time limit, with the option to add a gong sounds every couple of minutes.", belongsTo: "none", category: .unguided, img: Img.starfish, type: .course, id: 1, duration: 0, reward: 0),
        ...
        Meditation(title: "Bedtime Meditation", description: "Relax & fall asleep to this peaceful meditation", belongsTo: "none", category: .sleep, img: Img.sheep, type: .single, id: 54, duration: 600, reward: 10, url: "https://mcdn.podbean.com/mf/web/5cefi8/429_Bedtime_VOCALS7ekok.mp3"),
