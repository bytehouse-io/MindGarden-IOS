...
//        Meditation(title: "Open-Ended Meditation", description: "Unguided meditation with no time limit, with the option to add a gong sounds every couple of minutes.", belongsTo: "none", category: .unguided, img: Img.starfish, type: .course, id: 1, duration: 0, reward: 0),
        ...
        Meditation(title: "Timed Meditation", description: "Timed unguided (no talking) meditation, with the option to turn on background noises such as rain. A bell will signal the end of your session.", belongsTo: "none", category: .unguided, img: Img.chatBubble, type: .course, id: 2, duration: 0, reward: 0, url: "", instructor: "None"),
        Meditation(title: "1 Minute Meditation", description: "Timed unguided (no talking) meditation for a fixed period, with the option to turn on background noises such as rain. A bell will signal the end of your session.",  belongsTo: "Timed Meditation", category: .unguided, img: Img.daisy3, type: .lesson, id: 3, duration: 60, reward: 2, url: "", instructor: "None"),
        Meditation(title: "2 Minute Meditation", description: "Timed unguided (no talking) meditation for a fixed period, with the option to turn on background noises such as rain. A bell will signal the end of your session.",  belongsTo: "Timed Meditation", category: .unguided, img: Img.daisy3, type: .lesson, id: 4, duration: 120, reward: 4, url: "", instructor: "None"),
        Meditation(title: "5 Minute Meditation", description: "Timed unguided (no talking) meditation for a fixed period, with the option to turn on background noises such as rain. A bell will signal the end of your session.",  belongsTo: "Timed Meditation", category: .unguided, img: Img.daisy3, type: .lesson, id: 5, duration: 300, reward: 6, url: "", instructor: "None"),
        Meditation(title: "10 Minute Meditation", description: "Timed unguided (no talking) meditation for a fixed period, with the option to turn on background noises such as rain. A bell will signal the end of your session.",  belongsTo: "Timed Meditation", category: .unguided, img: Img.daisy3, type: .lesson, id: 28, duration: 600, reward: 10, url: "", instructor: "None"),
        Meditation(title: "15 Minute Meditation", description: "Timed unguided (no talking) meditation for a fixed period, with the option to turn on background noises such as rain. A bell will signal the end of your session.",  belongsTo: "Timed Meditation", category: .unguided, img: Img.daisy3, type: .lesson, id: 29, duration: 900, reward: 14, url: "", instructor: "None"),
        ...
        Meditation(title: "Handling Our Thoughts & Emotions", description: "", belongsTo: "Intro to Meditation", category: .courses, img: Img.happySunflower, type: .lesson, id: 9, duration: 383, reward: 8, url: "https://mcdn.podbean.com/mf/web/qripk5/day_3_intro_to_meditation_final93cb2.mp3", instructor: "Bijan"),
        Meditation(title: "Acceptance", description: "Learn how meditating can help you think and observe much more clearly.", belongsTo: "Intro to Meditation", category: .courses, img: Img.happySunflower, type: .lesson, id: 10, duration: 312, reward: 8, url: "https://mcdn.podbean.com/mf/web/eirruy/Day_4_intro_to_meditation_finalb1uko.mp3", instructor: "Andrew"),
        Meditation(title: "Gratitude", description: "Learn how daily meditation can be the perfect cure and preventer of stress and anxiety", belongsTo: "Intro to Meditation", category: .courses, img: Img.happySunflower, type: .lesson, id: 12, duration: 349, reward: 8, url: "https://mcdn.podbean.com/mf/web/brkva6/Day_5_Intro_to_Meditation_Finalbs7xv.mp3", instructor: "Bijan"),
        Meditation(title: "Compassion & Self-Love", description: "Discover how meditating can create boundless amounts of love & compassion for yourself & the people around you", belongsTo: "Intro to Meditation", category: .courses, img: Img.happySunflower, type: .lesson, id: 13, duration: 285, reward: 8, url: "https://mcdn.podbean.com/mf/web/y8wbsb/Day_6_Intro_to_Meditation_Finalahwwg.mp3", instructor: "Bijan"),
        Meditation(title: "Daily Practice", description: "Discover how meditating can help you create the super power of generating happiness on demand.", belongsTo: "Intro to Meditation", category: .courses, img: Img.happySunflower, type: .lesson, id: 11, duration: 166, reward: 8, url: "https://mcdn.podbean.com/mf/web/g8i975/Day_7_Intro_to_Meditation_Final7ewof.mp3", instructor: "Bijan"),

        //Intermediate Course
        Meditation(title: "7 Days to Happiness", description: "A 7 day series, where we use meditation to become focused, happier and motivated.", belongsTo: "none", category: .courses, img: Img.kiwi, type: .course, id: 14, duration: 0, reward: 0, url: "", instructor: "Lisa"),
        ...
        Meditation(title: "Deep Sleep", description: "A 20 minute meditation for people looking to quickly fall into a deep sleep", belongsTo: "none", category: .sleep, img: Img.moonFull, type: .single, id: 39, duration: 1285, reward: 20, url: "https://mcdn.podbean.com/mf/web/4vxfi9/366_Deep_Sleep_VOCALS86ffx.mp3", instructor: "Lisa"),
        Meditation(title: "Meditation for Happiness", description: "Learn that happiness, just like anything else in life can be learned..", belongsTo: "none", category: .growth, img: Img.daisy3, type: .single, id: 40, duration: 1227, reward: 20, url: "https://mcdn.podbean.com/mf/web/hu3net/372_Meditation_for_Happiness_VOCALS827d7.mp3", instructor: "Lisa"),
        Meditation(title: "Build Confidence", description: "Learn to feel confidence and break away from your negative thought patterns", belongsTo: "none", category: .confidence, img: Img.sunglasses, type: .single, id: 41, duration: 1160, reward: 20, url: "https://mcdn.podbean.com/mf/web/2aysdh/358_Experience_Confidence_VOCALS64r7q.mp3", instructor: "Lisa"),
        Meditation(title: "Emotional Balance", description: "Learn to balance your tricky emotions and experience peace & clarity", belongsTo: "none", category: .growth, img: Img.watermelon, type: .single, id: 42, duration: 1143, reward: 20, url: "https://mcdn.podbean.com/mf/web/etnx62/361_Emotional_Balance_VOCALSaba3g.mp3", instructor: "Lisa"),
        ...
        Meditation(title: "It Lies Within You", description: "Learn that confidence lies within you and how to bring it out", belongsTo: "none", category: .confidence, img: Img.gnome, type: .single, id: 44, duration: 1154, reward: 20, url: "https://mcdn.podbean.com/mf/web/2aysdh/358_Experience_Confidence_VOCALS64r7q.mp3", instructor: "Lisa"),
        Meditation(title: "How to Meditate", description: "Learn how to meditate and simply it truly is", belongsTo: "none", category: .beginners, img: Img.books, type: .single, id: 45, duration: 305, reward: 5, url: "https://mcdn.podbean.com/mf/web/tr4dnq/1403_How_To_Meditate_VOCALSbrsfv.mp3", instructor: "Lisa"),
        ...
        Meditation(title: "The Basics Course", description: "Learn the basics of meditaiton and why making it a habit can drastically improve happiness, focus and so much more", belongsTo: "none", category: .beginners, img: Img.juiceBoxes, type: .course, id: 67, duration: 0, reward: 0, url: "1d", instructor: "Andrew"),
        Meditation(title: "Why Meditate?", description: "Learn why millions of people around the world use this daily practice.", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 68, duration: 320, reward: 8, url: "", instructor: "Andrew"),
        Meditation(title: "Create Your Anchor", description: "Learn how to create an anchor that can help ground you during your most busy and stormy seasons.", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 69, duration: 322, reward: 8, url: "", instructor: "Andrew"),
        Meditation(title: "Tuning Into Your Body", description: "Discover how to use the body scan meditation to become more aware of your bodily experiences and the emotions tied to them.", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 70, duration: 429, reward: 8, url: "", instructor: "Andrew"),
        Meditation(title: "Gaining Clarity", description: "Learn how meditating can help you think and observe much more clearly.", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 71, duration: 292, reward: 8, url: "", instructor: "Andrew"),
        Meditation(title: "Stress Antidote", description: "Learn how daily meditation can be the perfect cure and preventer of stress and anxiety", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 72, duration: 365, reward: 8, url: "", instructor: "Andrew"),
        Meditation(title: "Compassion & Self-Love", description: "Discover how meditating can create boundless amounts of love & compassion for yourself & the people around you", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 73, duration: 314, reward: 8, url: "", instructor: "Andrew"),
        Meditation(title: "Joy on demand", description: "Discover how meditating can help you create the super power of generating happiness on demand.", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 74, duration: 324, reward: 8, url: "", instructor: "Andrew"),

        //Bijan's stuff
        Meditation(title: "Coping with Cravings", description: "Researchers have found that people who practice regular meditation had a lower likelihood of binge eating, worrying about food, and mindless snacking. The secret: being mindful.", belongsTo: "none", category: .beginners, img: Img.utensils, type: .single, id: 75, duration: 375, reward: 9, url: "https://mcdn.podbean.com/mf/web/krgcu9/Deal_With_Cravings62ffv.mp3", instructor: "Bijan"),
        Meditation(title: "Caring for our anger", description: "Sit down and take a deep breath with Bijan. It's okay to be frustrated and upset, but constantly being in that state of mind is depleting and stressful. Break free with meditaiton", belongsTo: "none", category: .beginners, img: Img.angryFire, type: .single, id: 76, duration: 578, reward: 16, url: "https://mcdn.podbean.com/mf/web/quuidx/Caring_for_our_Anger6iuut.mp3", instructor: "Bijan"),
