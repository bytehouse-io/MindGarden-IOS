...
//        Meditation(title: "Open-Ended Meditation", description: "Unguided meditation with no time limit, with the option to add a gong sounds every couple of minutes.", belongsTo: "Unguided", category: .unguided, img: Img.starfish, type: .course, id: 1, duration: 0, reward: 0),
        ...
        Meditation(title: "1 Minute Meditation", description: "Timed unguided (no talking) meditation for a fixed period, with the option to turn on background noises such as rain. A bell will signal the end of your session.",  belongsTo: "Timed Meditation", category: .unguided, img: Img.alarmClock, type: .lesson, id: 3, duration: 60, reward: 2, url: "", instructor: "Unguided", imgURL: "", isNew: false),
        Meditation(title: "2 Minute Meditation", description: "Timed unguided (no talking) meditation for a fixed period, with the option to turn on background noises such as rain. A bell will signal the end of your session.",  belongsTo: "Timed Meditation", category: .unguided, img: Img.alarmClock, type: .lesson, id: 4, duration: 120, reward: 4, url: "", instructor: "Unguided", imgURL: "", isNew: false),
        Meditation(title: "5 Minute Meditation", description: "Timed unguided (no talking) meditation for a fixed period, with the option to turn on background noises such as rain. A bell will signal the end of your session.",  belongsTo: "Timed Meditation", category: .unguided, img: Img.alarmClock, type: .lesson, id: 5, duration: 300, reward: 6, url: "", instructor: "Unguided", imgURL: "", isNew: false),
        Meditation(title: "10 Minute Meditation", description: "Timed unguided (no talking) meditation for a fixed period, with the option to turn on background noises such as rain. A bell will signal the end of your session.",  belongsTo: "Timed Meditation", category: .unguided, img: Img.alarmClock, type: .lesson, id: 28, duration: 600, reward: 10, url: "", instructor: "Unguided", imgURL: "", isNew: false),
        Meditation(title: "15 Minute Meditation", description: "Timed unguided (no talking) meditation for a fixed period, with the option to turn on background noises such as rain. A bell will signal the end of your session.",  belongsTo: "Timed Meditation", category: .unguided, img: Img.alarmClock, type: .lesson, id: 29, duration: 900, reward: 14, url: "", instructor: "Unguided", imgURL: "", isNew: false),
        ...
        Meditation(title: "30 Minute Meditation", description: "Timed unguided (no talking) meditation for a fixed period, with the option to turn on background noises such as rain. A bell will signal the end of your session.",  belongsTo: "Timed Meditation", category: .unguided, img: Img.alarmClock, type: .lesson, id: 32, duration: 1800, reward: 22, url: "", instructor: "Unguided",  imgURL: "", isNew: false),
        Meditation(title: "45 Minute Meditation", description: "Timed unguided (no talking) meditation for a fixed period, with the option to turn on background noises such as rain. A bell will signal the end of your session.",  belongsTo: "Timed Meditation", category: .unguided, img: Img.alarmClock, type: .lesson, id: 33, duration: 2700, reward: 25, url: "", instructor: "Unguided",  imgURL: "", isNew: false),
        Meditation(title: "1 Hour Meditation", description: "Timed unguided (no talking) meditation for a fixed period, with the option to turn on background noises such as rain. A bell will signal the end of your session.",  belongsTo: "Timed Meditation", category: .unguided, img: Img.alarmClock, type: .lesson, id: 34, duration: 3600, reward: 30, url: "", instructor: "Unguided",  imgURL: "", isNew: false),
        Meditation(title: "2 Hour Meditation", description: "Timed unguided (no talking) meditation for a fixed period, with the option to turn on background noises such as rain. A bell will signal the end of your session.",  belongsTo: "Timed Meditation", category: .unguided, img: Img.alarmClock, type: .lesson, id: 35, duration: 7200, reward: 35, url: "", instructor: "Unguided",  imgURL: "", isNew: false),
        ...
        Meditation(title: "Basic Guided Meditation", description: "A 5 minute guided meditation to help you start or end the day in a mindful matter.", belongsTo: "Unguided", category: .beginners, img: Img.starfish, type: .single, id: 23, duration: 310, reward: 5, url: "https://mcdn.podbean.com/mf/web/8cuz7s/Basic_Guided_Meditationbwagl.mp3", instructor: "Andrew",  imgURL: "", isNew: false),
        Meditation(title: "Semi-Guided Meditation", description: "A 10 minute semi-guided meditation for more advanced meditators looking to start or end their day present, focused, and calm.", belongsTo: "Unguided", category: .beginners, img: Img.feather, type: .single, id: 24, duration: 607, reward: 10, url: "https://mcdn.podbean.com/mf/web/56xviu/Semi-Guided_Meditation6qqb0.mp3", instructor: "Andrew",  imgURL: "", isNew: false),
        Meditation(title: "Meditation for Focus", description: "A simple 5 minute guided meditation to help you calm your mind, and enter a relaxed focused state.", belongsTo: "Unguided", category: .focus, img: Img.magnifyingGlass, type: .single, id: 25, duration: 315, reward: 5, url: "https://mcdn.podbean.com/mf/web/7d2g5m/Meditation_for_Focus8fetr.mp3", instructor: "Andrew",  imgURL: "", isNew: false),
        ...
        Meditation(title: "Better Faster Sleep", description: "A 5 minute guided meditation to help you relax, let go and fall into a deep restful sleep.", belongsTo: "Unguided", category: .sleep, img: Img.moon, type: .single, id: 27, duration: 335, reward: 5, url: "https://mcdn.podbean.com/mf/web/n283c3/Better_Faster_Sleep9pxwf.mp3", instructor: "Andrew",  imgURL: "", isNew: false),
        // girl
        Meditation(title: "Chronic Pain, Safe Place", description: "Learn to deal with chronic stress and ease the emotional stress it brings through breath work.", belongsTo: "Unguided", category: .anxiety, img: Img.house, type: .single, id: 36, duration: 828, reward: 15, url: "https://mcdn.podbean.com/mf/web/3x43dz/228_Relieve_Stress_and_Activate_Intuition_VOCALSaj10d.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "A Sense of Gratitude", description: "In this meditation learn how to cultivate a sense of gratitude.", belongsTo: "Unguided", category: .growth, img: Img.wateredPot, type: .single, id: 37, duration: 1147, reward: 20, url: "https://mcdn.podbean.com/mf/web/gjbfjp/365_Sense_of_Gratitude_VOCALS6inm8.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "Relieve Stress, Activate Intuition", description: "Learn the secret to relieving stress, and activating your inner intuition", belongsTo: "Unguided", category: .anxiety, img: Img.brain, type: .single, id: 38, duration: 1225, reward: 21, url: "https://mcdn.podbean.com/mf/web/3x43dz/228_Relieve_Stress_and_Activate_Intuition_VOCALSaj10d.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "Deep Sleep", description: "A 20 minute meditation for people looking to quickly fall into a deep sleep", belongsTo: "Unguided", category: .sleep, img: Img.moonFull, type: .single, id: 39, duration: 1285, reward: 20, url: "https://mcdn.podbean.com/mf/web/4vxfi9/366_Deep_Sleep_VOCALS86ffx.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "Meditation for Happiness", description: "Learn that happiness, just like anything else in life can be learned..", belongsTo: "Unguided", category: .growth, img: Img.daisy3, type: .single, id: 40, duration: 1227, reward: 20, url: "https://mcdn.podbean.com/mf/web/hu3net/372_Meditation_for_Happiness_VOCALS827d7.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "Build Confidence", description: "Learn to feel confidence and break away from your negative thought patterns", belongsTo: "Unguided", category: .confidence, img: Img.sunglasses, type: .single, id: 41, duration: 1160, reward: 20, url: "https://mcdn.podbean.com/mf/web/2aysdh/358_Experience_Confidence_VOCALS64r7q.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "Emotional Balance", description: "Learn to balance your tricky emotions and experience peace & clarity", belongsTo: "Unguided", category: .growth, img: Img.watermelon, type: .single, id: 42, duration: 1143, reward: 20, url: "https://mcdn.podbean.com/mf/web/etnx62/361_Emotional_Balance_VOCALSaba3g.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "Basic Confidence Meditation", description: "A basic guided meditation to build confidence and break away from your negative thought patterns", belongsTo: "Unguided", category: .confidence, img: Img.palm, type: .single, id: 43, duration: 845, reward: 15, url: "https://mcdn.podbean.com/mf/web/2aysdh/358_Experience_Confidence_VOCALS64r7q.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "It Lies Within You", description: "Learn that confidence lies within you and how to bring it out", belongsTo: "Unguided", category: .confidence, img: Img.gnome, type: .single, id: 44, duration: 1154, reward: 20, url: "https://mcdn.podbean.com/mf/web/2aysdh/358_Experience_Confidence_VOCALS64r7q.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "How to Meditate", description: "Learn how to meditate and simply it truly is", belongsTo: "Unguided", category: .beginners, img: Img.books, type: .single, id: 45, duration: 305, reward: 5, url: "https://mcdn.podbean.com/mf/web/tr4dnq/1403_How_To_Meditate_VOCALSbrsfv.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        ...
        Meditation(title: "Good Morning, Positive Energy", description: "Learn how to cultive creatity and boost inspiration by being present.", belongsTo: "Unguided", category: .growth, img: Img.eggs, type: .single, id: 49, duration: 607, reward: 10, url: "https://mcdn.podbean.com/mf/web/h6wmv9/1523_Good_Morning_Positive_Energy_Meditation_10_min_VOCALSbgvsn.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "Affirmations", description: "Affirmations for health, wealth, love and happiness.", belongsTo: "Unguided", category: .growth, img: Img.bee, type: .single, id: 50, duration: 632, reward: 10, url: "https://mcdn.podbean.com/mf/web/y39bbt/1432_Guided_Meditation_for_Anxiety_10_min_VOCALSajbr7.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "Clearing Fears", description: "Learn to focus on what you can control & to quiet your fears", belongsTo: "Unguided", category: .anxiety, img: Img.hand, type: .single, id: 51, duration: 547, reward: 10, url: "https://mcdn.podbean.com/mf/web/rtmi4k/1540_Clearing_Fears_Held_in_the_Body_Scan_9_min_VOCALS8kge3.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "Handle Insecurity", description: "Learn to quiet your insecurities and replace it with inspiration.", belongsTo: "Unguided", category: .anxiety, img: Img.wave, type: .single, id: 52, duration: 1185, reward: 20, url: "https://mcdn.podbean.com/mf/web/xm4jyj/390_Handle_Insecurity_VOCALS92hmv.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "Seize the Day", description: "Prepare yourself to crush the day ahead with a smile.", belongsTo: "Unguided", category: .growth, img: Img.sun, type: .single, id: 53, duration: 626, reward: 10, url: "https://mcdn.podbean.com/mf/web/rucidp/1398_Seize_the_Day_Morning_Meditation_VOCALSb63wx.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "Bedtime Meditation", description: "Relax & fall asleep to this peaceful meditation", belongsTo: "Unguided", category: .sleep, img: Img.sheep, type: .single, id: 54, duration: 600, reward: 10, url: "https://mcdn.podbean.com/mf/web/5cefi8/429_Bedtime_VOCALS7ekok.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        ...
        Meditation(title: "Exam Anxiety Meditation", description: "Feeling test jitters? Can't focus? Overthinking? Use this meditation to enter a calm zen state.", belongsTo: "Unguided", category: .anxiety, img: Img.cando, type: .single, id: 56, duration: 672, reward: 10, url: "https://mcdn.podbean.com/mf/web/4ywe6m/exam-anxiety-meditation.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        ...
        Meditation(title: "Why Meditate?", description: "Learn why millions of people around the world use this daily practice.", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 68, duration: 320, reward: 8, url: "https://firebasestorage.googleapis.com/v0/b/mindgarden-b9527.appspot.com/o/Why%20Meditate%3F.mp3?alt=media&token=8e12978b-bb52-4692-b149-d9021f2a41a1", instructor: "Andrew",  imgURL: "", isNew: false),
        Meditation(title: "Create Your Anchor", description: "Learn how to create an anchor that can help ground you during your most busy and stormy seasons.", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 69, duration: 322, reward: 8, url: "https://firebasestorage.googleapis.com/v0/b/mindgarden-b9527.appspot.com/o/Create%20Your%20Anchor.mp3?alt=media&token=87476158-7d3f-4401-be1f-b59ba3721c07", instructor: "Andrew",  imgURL: "", isNew: false),
        Meditation(title: "Tuning Into Your Body", description: "Discover how to use the body scan meditation to become more aware of your bodily experiences and the emotions tied to them.", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 70, duration: 429, reward: 8, url: "https://firebasestorage.googleapis.com/v0/b/mindgarden-b9527.appspot.com/o/Tuning%20Into%20Your%20Body.mp3?alt=media&token=cc115cc6-564c-45fd-8779-ffe952239d20", instructor: "Andrew",  imgURL: "", isNew: false),
        Meditation(title: "Gaining Clarity", description: "Learn how meditating can help you think and observe much more clearly.", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 71, duration: 292, reward: 8, url: "https://firebasestorage.googleapis.com/v0/b/mindgarden-b9527.appspot.com/o/Gaining%20Clarity.mp3?alt=media&token=5b515222-eb5c-49d1-a9fb-a996299e9f3b", instructor: "Andrew",  imgURL: "", isNew: false),
        Meditation(title: "Stress Antidote", description: "Learn how daily meditation can be the perfect cure and preventer of stress and anxiety", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 72, duration: 365, reward: 8, url: "https://firebasestorage.googleapis.com/v0/b/mindgarden-b9527.appspot.com/o/Stress%20Antidote.mp3?alt=media&token=ca73b1f6-8172-456d-b2cb-1fea74a52d00", instructor: "Andrew",  imgURL: "", isNew: false),
        Meditation(title: "Compassion & Self-Love", description: "Discover how meditating can create boundless amounts of love & compassion for yourself & the people around you", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 73, duration: 314, reward: 8, url: "https://firebasestorage.googleapis.com/v0/b/mindgarden-b9527.appspot.com/o/Compassion%20%26%20Self-Love.mp3?alt=media&token=8fe2c170-27fc-4b7b-b754-073801a9d7db", instructor: "Andrew",  imgURL: "", isNew: false),
        Meditation(title: "Joy on demand", description: "Discover how meditating can help you create the super power of generating happiness on demand.", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 74, duration: 324, reward: 8, url: "https://firebasestorage.googleapis.com/v0/b/mindgarden-b9527.appspot.com/o/Joy%20on%20demand.mp3?alt=media&token=67539144-de86-4af8-99b3-b8b960efffc6", instructor: "Andrew",  imgURL: "", isNew: false),

        //Bijan's stuff
        Meditation(title: "Coping with Cravings", description: "Researchers have found that people who practice regular meditation had a lower likelihood of binge eating, worrying about food, and mindless snacking. The secret: being mindful.", belongsTo: "Unguided", category: .beginners, img: Img.utensils, type: .single, id: 75, duration: 375, reward: 9, url: "https://mcdn.podbean.com/mf/web/krgcu9/Deal_With_Cravings62ffv.mp3", instructor: "Bijan",  imgURL: "", isNew: false),
        Meditation(title: "Caring for our anger", description: "Sit down and take a deep breath with Bijan. It's okay to be frustrated and upset, but constantly being in that state of mind is depleting and stressful. Break free with meditaiton", belongsTo: "Unguided", category: .beginners, img: Img.angryFire, type: .single, id: 76, duration: 578, reward: 16, url: "https://mcdn.podbean.com/mf/web/quuidx/Caring_for_our_Anger6iuut.mp3", instructor: "Bijan",  imgURL: "", isNew: false),
