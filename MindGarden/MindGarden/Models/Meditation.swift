...
//        Meditation(title: "Open-Ended Meditation", description: "Unguided meditation with no time limit, with the option to add a gong sounds every couple of minutes.", belongsTo: "Unguided", category: .unguided, img: Img.starfish, type: .course, id: 1, duration: 0, reward: 0),
        ...
        Meditation(title: "Clearing the Mind", description: "Learn the fundamentals of clearing all the noise in your head so you can finally learn to listen the right signals.", belongsTo: "7 Days to Happiness", category: .beginners, img: Img.gnome, type: .single_and_lesson, id: 15, duration: 617, reward: 100, url: "https://mcdn.podbean.com/mf/web/khbnmt/1454C_Clearing_the_Mind_10_min_VOCALS929z1.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "Cultivate Self Love", description: "Do you constantly put your self down? Learn the basics of loving yourself and accepting who you are.", belongsTo: "7 Days to Happiness", category: .growth, img: Img.lemon, type: .single_and_lesson, id: 16, duration: 629, reward: 100, url: "https://mcdn.podbean.com/mf/web/jsffxx/1441_Cultivate_Beautiful_Self_Love_-_10_min_VOCALSa4nt3.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "Creativity & Inspiration", description: "Do you constantly feel stuck? Learn how to break-through and unleash the creativity hidden inside you", belongsTo: "7 Days to Happiness", category: .focus, img: Img.pencil, type: .single_and_lesson, id: 17, duration: 606, reward: 100, url: "https://mcdn.podbean.com/mf/web/bgbwzn/1446C_Enhance_Creativity_and_Boost_Inspiration_10_min_VOCALSaiunb.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "Sustain Focus & Increase Motivation", description: "Build the discipline of laser like focus and rock solid motivation through some breath work and simple observation", belongsTo: "7 Days to Happiness", category: .focus, img: Img.target, type: .single_and_lesson, id: 18, duration: 615, reward: 100, url: "https://mcdn.podbean.com/mf/web/244bfv/1440C_Sustain_Focus_and_Increase_Motivation_10_min_VOCALS8fk39.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "The Basics", description: "A simple 10 minute guided meditaiton you can do anywhere at anytime, empty the mind, get relaxed and receive clarity.", belongsTo: "7 Days to Happiness", category: .beginners, img: Img.icecream, type: .single_and_lesson, id: 19, duration: 616, reward: 100, url: "https://mcdn.podbean.com/mf/web/2p2ww9/1433_10_Minute_Guided_Meditation_that_you_can_listen_to_every_day_VOCALS9v8ek.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "Thankful Meditation for Gratitude", description: "Gratitude is the easiest thing you can do to become happier, learn to truly be thankful when having a clear focused mind.", belongsTo: "7 Days to Happiness", category: .growth, img: Img.hands, type: .single_and_lesson, id: 20, duration: 608, reward: 100, url: "https://mcdn.podbean.com/mf/web/ez7xsw/1456C_Thankful_Meditation_for_Gratitude_10_min_VOCALSbfhth.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "Life is Beautiful", description: "When you have no agenda, and simply observe you come to realize just how breath taking life truly is.", belongsTo: "7 Days to Happiness", category: .growth, img: Img.apple3, type: .single_and_lesson, id: 21, duration: 623, reward: 100, url: "https://mcdn.podbean.com/mf/web/5w8mig/1530_A_Meditation_Called_Life_is_Beautiful_10_min_VOCALS99c8u.mp3", instructor: "Lisa",  imgURL: "", isNew: false),

        // Singles
        Meditation(title: "30 Second Meditation", description: "A super quick, 30 second breath work session.", belongsTo: "Unguided", category: .all, img: Img.strawberryMilk, type: .single, id: 22, duration: 29, reward: 20, url: "", instructor: "Bijan",  imgURL: "", isNew: false),
        ...
        Meditation(title: "Better Faster Sleep", description: "A 5 minute guided meditation to help you relax, let go and fall into a deep restful sleep.", belongsTo: "Unguided", category: .sleep, img: Img.moon, type: .single, id: 27, duration: 335, reward: 60, url: "https://mcdn.podbean.com/mf/web/n283c3/Better_Faster_Sleep9pxwf.mp3", instructor: "Andrew",  imgURL: "", isNew: false),
        // girl
        ...
        Meditation(title: "Clearing Fears", description: "Learn to focus on what you can control & to quiet your fears", belongsTo: "Unguided", category: .anxiety, img: Img.hand, type: .single, id: 51, duration: 547, reward: 100, url: "https://mcdn.podbean.com/mf/web/rtmi4k/1540_Clearing_Fears_Held_in_the_Body_Scan_9_min_VOCALS8kge3.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
