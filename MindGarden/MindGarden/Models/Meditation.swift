...
//        Meditation(title: "Open-Ended Meditation", description: "Unguided meditation with no time limit, with the option to add a gong sounds every couple of minutes.", belongsTo: "none", category: .unguided, img: Img.starfish, type: .course, id: 1, duration: 0, reward: 0),
        ...
        //Intermediate Course
        Meditation(title: "7 Days to Happiness", description: "A 7 day series, where we use meditation to become focused, happier and motivated.", belongsTo: "none", category: .courses, img: Img.kiwi, type: .course, id: 14, duration: 0, reward: 0, url: "", instructor: "Lisa",  imgURL: "", isNew: false),
        ...
        // Singles
        Meditation(title: "30 Second Meditation", description: "A super quick, 30 second breath work session.", belongsTo: "none", category: .all, img: Img.strawberryMilk, type: .single, id: 22, duration: 37, reward: 1, url: "", instructor: "Andrew",  imgURL: "", isNew: false),
        ...
        Meditation(title: "Deep Sleep", description: "A 20 minute meditation for people looking to quickly fall into a deep sleep", belongsTo: "none", category: .sleep, img: Img.moonFull, type: .single, id: 39, duration: 1285, reward: 20, url: "https://mcdn.podbean.com/mf/web/4vxfi9/366_Deep_Sleep_VOCALS86ffx.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        ...
        Meditation(title: "It Lies Within You", description: "Learn that confidence lies within you and how to bring it out", belongsTo: "none", category: .confidence, img: Img.gnome, type: .single, id: 44, duration: 1154, reward: 20, url: "https://mcdn.podbean.com/mf/web/2aysdh/358_Experience_Confidence_VOCALS64r7q.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "How to Meditate", description: "Learn how to meditate and simply it truly is", belongsTo: "none", category: .beginners, img: Img.books, type: .single, id: 45, duration: 305, reward: 5, url: "https://mcdn.podbean.com/mf/web/tr4dnq/1403_How_To_Meditate_VOCALSbrsfv.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        ...
        Meditation(title: "Handle Insecurity", description: "Learn to quiet your insecurities and replace it with inspiration.", belongsTo: "none", category: .anxiety, img: Img.wave, type: .single, id: 52, duration: 1185, reward: 20, url: "https://mcdn.podbean.com/mf/web/xm4jyj/390_Handle_Insecurity_VOCALS92hmv.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "Seize the Day", description: "Prepare yourself to crush the day ahead with a smile.", belongsTo: "none", category: .anxiety, img: Img.sun, type: .single, id: 53, duration: 626, reward: 10, url: "https://mcdn.podbean.com/mf/web/rucidp/1398_Seize_the_Day_Morning_Meditation_VOCALSb63wx.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        Meditation(title: "Bedtime Meditation", description: "Relax & fall asleep to this peaceful meditation", belongsTo: "none", category: .sleep, img: Img.sheep, type: .single, id: 54, duration: 600, reward: 10, url: "https://mcdn.podbean.com/mf/web/5cefi8/429_Bedtime_VOCALS7ekok.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
        ...
        Meditation(title: "The Basics Course", description: "Learn the basics of meditaiton and why making it a habit can drastically improve happiness, focus and so much more", belongsTo: "none", category: .beginners, img: Img.juiceBoxes, type: .course, id: 67, duration: 0, reward: 0, url: "1d", instructor: "Andrew",  imgURL: "", isNew: false),
        Meditation(title: "Why Meditate?", description: "Learn why millions of people around the world use this daily practice.", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 68, duration: 320, reward: 8, url: "", instructor: "Andrew",  imgURL: "", isNew: false),
        Meditation(title: "Create Your Anchor", description: "Learn how to create an anchor that can help ground you during your most busy and stormy seasons.", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 69, duration: 322, reward: 8, url: "", instructor: "Andrew",  imgURL: "", isNew: false),
        Meditation(title: "Tuning Into Your Body", description: "Discover how to use the body scan meditation to become more aware of your bodily experiences and the emotions tied to them.", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 70, duration: 429, reward: 8, url: "", instructor: "Andrew",  imgURL: "", isNew: false),
        Meditation(title: "Gaining Clarity", description: "Learn how meditating can help you think and observe much more clearly.", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 71, duration: 292, reward: 8, url: "", instructor: "Andrew",  imgURL: "", isNew: false),
        Meditation(title: "Stress Antidote", description: "Learn how daily meditation can be the perfect cure and preventer of stress and anxiety", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 72, duration: 365, reward: 8, url: "", instructor: "Andrew",  imgURL: "", isNew: false),
        Meditation(title: "Compassion & Self-Love", description: "Discover how meditating can create boundless amounts of love & compassion for yourself & the people around you", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 73, duration: 314, reward: 8, url: "", instructor: "Andrew",  imgURL: "", isNew: false),
        Meditation(title: "Joy on demand", description: "Discover how meditating can help you create the super power of generating happiness on demand.", belongsTo: "The Basics Course", category: .courses, img: Img.juiceBoxes, type: .lesson, id: 74, duration: 324, reward: 8, url: "", instructor: "Andrew",  imgURL: "", isNew: false),
