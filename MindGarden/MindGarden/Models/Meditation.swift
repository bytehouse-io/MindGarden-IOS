...
//        Meditation(title: "Open-Ended Meditation", description: "Unguided meditation with no time limit, with the option to add a gong sounds every couple of minutes.", belongsTo: "none", category: .unguided, img: Img.starfish, type: .course, id: 1, duration: 0, reward: 0),
        ...
        Meditation(title: "Seize the Day", description: "Prepare yourself to crush the day ahead with a smile.", belongsTo: "none", category: .growth, img: Img.sun, type: .single, id: 53, duration: 626, reward: 10, url: "https://mcdn.podbean.com/mf/web/rucidp/1398_Seize_the_Day_Morning_Meditation_VOCALSb63wx.mp3", instructor: "Lisa",  imgURL: "", isNew: false),
